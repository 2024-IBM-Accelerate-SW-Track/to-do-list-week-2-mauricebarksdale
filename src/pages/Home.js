...
class Home extends Component {
  ...
  addTodo = (todo) => {
    ...
    const found = this.state.todos.find((item) => item.content === todo.content);
  ...
  // Iterates through todo list to find todo item with matching id and then deletes it from the list.
  deleteTodo = (id) => {
